...
3. Call `mcp__dashboard_tools__generate_typescript` with returned metadata AND `crud_scaffolds`
...
When calling `generate_typescript`, pass `crud_scaffolds` — a list of entity identifiers for which ready-made CRUD pages will be generated automatically. This saves significant time!
...
generate_typescript → metadata, crud_scaffolds: ["team_members", "categories"]
